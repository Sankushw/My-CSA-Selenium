...
public class Page03_ResponsePricing {
	...
	@FindBy(id = "FLD_ST_BILL_RT")
	private WebElement ST_rate;
	//@FindBy(id = "FLD_SEC_TIER_ST_BILL_RATE")
	private WebElement Tier_ST_rate;
	@FindBy(id = "FLD_OT_BILL_RATE")
	private WebElement OT_rate;
	@FindBy(id = "FLD_ST_WAGE")
	private WebElement ST_wage;
	@FindBy(xpath = ".//*[@id='ibm-content-main']//input[@class='ibm-btn-arrow-pri']")
