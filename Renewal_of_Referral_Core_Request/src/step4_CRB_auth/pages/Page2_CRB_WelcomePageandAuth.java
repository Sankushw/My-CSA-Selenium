...
public class Page2_CRB_WelcomePageandAuth 
{
	...
	@FindBy (xpath = ".//*[@id='content-main']/form/table[4]/tbody/tr[2]/td[5]/a") private WebElement Skill_name ;

	@FindBy(name="tblcolCandId") private WebElement  Select_Checkbox ;
	@FindBy (name="btnAuthSel") private WebElement Authorize_selected ;
	@FindBy (xpath=".//*[@id='content-main']/div/span/input") private WebElement Authorize_selected_Again ;
        ...
        public void Switch_ins ()
        {
    		...
    		GO_reqnum.click();
    		 ...
    		 WebDriverWait wait03 = new WebDriverWait(driver, 160);
    			wait03.until(ExpectedConditions.visibilityOf(Skill_name)); 
