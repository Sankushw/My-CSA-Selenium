...
public class Page2_CRB_WelcomePageandAuth 
{
	...
	@FindBy (xpath = ".//*[@id='left-nav']/div/div/a[1]") private WebElement Skill_Line_Items ;
	...
	@FindBy (name="btnAuthFin") private WebElement Authorize_selected ;
	@FindBy (name="btnAuthSel") private WebElement Authorize_selected_Again ;
	...
	public static String xlsFilePath = System.getProperty("user.dir") + "\\src\\testdata\\testdata.xls";
		...
		//Function to click authorization button
        public void Switch_ins ()
        {
			...
			wait06.until(ExpectedConditions.visibilityOf(Skill_Line_Items));
...
File srcFile = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE) ;
	...
	try {
    	...
    	Authorize_selected.click();
 		...
 		wait04.until(ExpectedConditions.visibilityOf(Authorize_selected_Again)); 
...
File srcFile1 = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE) ;
	...
	Authorize_selected_Again.click();
    	
    	
	 WebDriverWait wait05 = new WebDriverWait(driver, 160);
		wait05.until(ExpectedConditions.visibilityOf(ExitReq)); 
