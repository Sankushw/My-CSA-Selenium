...
public class Page08A_Service_Identification {
	...
	@FindBy(xpath = ".//*[@id='FLD_DISCUSS_PROC']")
	private WebElement Procurement_Yes;
	@FindBy(xpath = ".//*[@id='FLD_PRE_APPROVAL']")
	private WebElement Preapproval_yes;
	@FindBy(name = "FLD_RCMMD_SCND_TIER_SUPP")
	private WebElement Tier_Supplier_solution_Provider_Name;
