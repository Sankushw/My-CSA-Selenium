...
public class Step03_SBReturn_NonCore {
  ...
  private WebDriver driver;
	...
	@FindBy (name = "btnSaveAndReturn") private WebElement SaveAndReturn;
	...
	public Step03_SBReturn_NonCore(WebDriver driver)
	{
		this.driver=driver;
    ...
    public void SB_Return ()
    {
		...
		wait05.until(ExpectedConditions.visibilityOf(SaveAndReturn));
		SuppNum.sendKeys("1000118974");
		CommentsToReq.sendKeys("returned");
		//MastrNum.sendKeys("MA Test");
		FairValueAnalysis.sendKeys("returned");
